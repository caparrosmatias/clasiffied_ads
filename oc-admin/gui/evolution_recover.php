...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
        <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0);"><?php _e('Password Recovery Page'); ?></a>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 ml-auto mr-auto">
                    <form id="recoverform" class="form" name="recoverform" action="<?php echo osc_admin_base_url(true); ?>" method="post">
                        ...
                        <div class="card card-login card-hidden">
                            <div class="card-header card-header-info text-center">
                                <h4 class="card-title"><?php _e('Recover Password'); ?></h4>
                            </div>
                            <div class="card-body ">
                                ...
                                <div class="bmd-form-group">
                                    <div class="input-group">
                                        ...
                                        <input id="user_email" class="form-control" type="email" name="email" placeholder="<?php _e('E-mail'); ?>..." required="true">
                                    </div>
                                </div>
                            </div>

                            <div class="card-footer justify-content-center">
                                <button type="submit" class="btn btn-info btn-link btn-lg"><?php echo osc_esc_html( __('Get new password')); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
