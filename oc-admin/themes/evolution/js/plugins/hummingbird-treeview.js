(function($){
	...
	$.fn.hummingbird.checkAll = function(tree){
		tree.children("li").children("div").children("label").children("input:checkbox").prop('indeterminate', false).prop('checked', false).trigger("click");
		//tree.children("li").children("div").children("label").children("input:checkbox").prop('indeterminate', false).prop('checked', false).trigger("click");
	};
	...
	$.fn.hummingbird.uncheckAll = function(tree){
		...
		tree.children("li").children("div").children("label").children("input:checkbox").prop('indeterminate', false).prop('checked', true).trigger("click");
	...
	$.fn.hummingbird.ThreeStateLogic = function(tree,doubleMode,allVariables,checkDoubles,checkDisabled) {
		tree.find('input:checkbox').on('click', function(e) {
			...
			//all not disabled
			var nodes_below_not_disabled = $(this).parent("label").parent("div").parent("li").find("input:checkbox:not(:disabled)");

			//all disabled without hummingbird-end-node
			var nodes_below_disabled_groups = $(this).parent("label").parent("div").parent("li").find('input:checkbox:disabled:not(.hummingbird-end-node)');
