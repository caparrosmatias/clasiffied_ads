...
<div class="card">
    <div class="card-header card-header-rose card-header-icon">
        ...
        <h4 class="card-title"><?php _e('Add new theme'); ?></h4>
    </div>
    ...
    <div class="card-body">
                ...
                <div class="row no-gutters">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row no-gutters">
                                    <label class="col-12 col-sm-3 col-xl-1 col-form-label text-left"><?php _e('Theme package (.zip)'); ?></label>
        ...
        <?php else: ?>
            <div class="row no-gutters">
                <div class="col-md-6">
                    <div class="alert alert-danger"><?php _e("Can't install a new theme"); ?></div>
                    <p><?php _e("The theme folder is not writable on your server so you can't upload themes from the administration panel. Please make the theme folder writable and try again."); ?></p>
                    <p><?php _e('To make the directory writable under UNIX execute this command from the shell:'); ?></p>
                    <pre class="mark rounded p-3 w-100">chmod 0755 <?php echo osc_themes_path(); ?></pre>
                </div>
            </div>
        <?php endif; ?>
    </div>
