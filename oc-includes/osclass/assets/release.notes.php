...
<td>
<!-- Table -->
<table id="Table_01" width="700" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica, 'Helvetica Neue', 'Helvetica light', Arial, sans-serif; text-align:center;font-size:1px;line-height:1px;margin:0" align="center">
<tbody><tr>
...
<tr>
    <td style="background-color:#2FC6D8; font-size:1px;line;height:0; border-collapse:collapse;">
        <img src="<?php echo osc_base_url().'oc-includes/osclass/assets/'; ?>images/mockup_03.png" width="700" height="23" alt="Better market, templates for static pages, email templates," style="color:#ffffff;font-size:15px;font-weight:200;line-height:15px;background-color:#2FC6D8"></td>
</tr>
...
<tr>
    <td style="height: 10px; width: 40px;"><img src="<?php echo osc_base_url().'oc-includes/osclass/assets/'; ?>images/t.gif" height="10" width="40"></td>
        ...
        <table height="5" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px; height: 12px; background-color: #f4f8fb; border: 0px; border-collapse: collapse; font-family: Arial, Helvetica, Verdana, sans-serif;">
            <tbody><tr valign="top">
                ...
                <td width="420" style="width: 420px;">
                    <div style="font-size:25px;line-height:25px;border-bottom:solid 1px #dbdbdb;padding-bottom:5px;padding-top:5px"><a href="http://osclass.org/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=version_380C&amp;utm_content=sub-title" style="color:#555555;text-decoration:none;">Osclass 3.8.1 highlights</a></div><img src="<?php echo osc_base_url().'oc-includes/osclass/assets/'; ?>images/t.gif" width="420" height="25" alt="">
                    <div style="font-size:13px; line-height:15px;color:#555555;">
                        <ul style="color:#555555;margin: 0;padding: 0;padding-left: 16px; list-style-type: disc !important;">
                            <li>Fixed php 7.3 compatibility</li>
                            <li>Reduced time to check for updates</li>
                            <li>old market removed</li>
                            <li>data-vocabulary.org breadcrumb markup changed to schema.org/BreadcrumbList</li>
...
<tr style="height: 1px; line-height: 1px;"><td colspan="4" style="background-color: #34c3da; width: 4px; height: 40px; font-size: 1px; line-height: 1px;">
        <img src="<?php echo osc_base_url().'oc-includes/osclass/assets/'; ?>images/t.gif" width="4" height="40" alt=""></td>
