...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_locale (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_country (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_currency (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_region (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_city (
    pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_city_area (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_widget (
    pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_user_description (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_user_email_tmp (
    fk_i_user_id INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_category (
    pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_category_description (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_category_stats (
    fk_i_category_id INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_item_description (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_item_location (
    fk_i_item_id INT(10) UNSIGNED NOT NULL,
    fk_c_country_code CHAR(2) NULL,
    s_country VARCHAR(40) NULL,
    s_address VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_item_stats (
    fk_i_item_id INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_item_resource (
    pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    fk_i_item_id INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_item_comment (
    pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    fk_i_item_id INT(10) UNSIGNED NOT NULL,
    dt_pub_date DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_plugin_category (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_alerts_sent (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_keywords (
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_latest_searches (
  d_date DATETIME NOT NULL,
  s_search VARCHAR(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARACTER SET 'UTF8' COLLATE 'UTF8_GENERAL_CI';

CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_meta_fields (
    pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    s_name VARCHAR(255) NOT NULL,
    s_slug VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_meta_categories (
    fk_i_category_id INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_item_meta (
    fk_i_item_id INT(10) UNSIGNED NOT NULL,
    fk_i_field_id INT(10) UNSIGNED NOT NULL,
    s_value TEXT NULL,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_city_stats (
    fk_i_city_id INT(10) UNSIGNED NOT NULL,
    i_num_items INT(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_region_stats (
    fk_i_region_id INT(10) UNSIGNED NOT NULL,
    i_num_items INT(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_country_stats (
    fk_c_country_code CHAR(2) NOT NULL,
    i_num_items INT(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_locations_tmp (
    id_location varchar(10) NOT NULL,
    e_type enum('COUNTRY','REGION','CITY') NOT NULL,
    PRIMARY KEY (id_location, e_type)
) ENGINE=InnoDB DEFAULT CHARACTER SET 'UTF8' COLLATE 'UTF8_GENERAL_CI';

CREATE TABLE IF NOT EXISTS  /*TABLE_PREFIX*/t_ban_rule (
  pk_i_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
