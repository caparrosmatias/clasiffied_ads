...
class ItemsDataTable extends DataTable
{
    ...
    private function addTableHeader()
    {
        ...
        $this->addColumn('date', '<a href="'.osc_esc_html($url_base.$arg_date).'" class="text-info">'.__('Date').'</a>');
        $this->addColumn('expiration', '<a href="'.osc_esc_html($url_base.$arg_expiration).'" class="text-info">'.__('Expiration date').'</a>');
        ...
        if(!empty($items)) {
            ...
            foreach($items as $aRow) {
                ...
                if(osc_get_preference('admin_theme') == 'modern') {
                    ...
                    if($aRow['b_active']) {
                        $options_more[] = '<a class="dropdown-item"  href="' . osc_admin_base_url(true) . '?page=items&amp;action=status&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;value=INACTIVE">' . __('Deactivate') .'</a>';
                    } else {
                    ...
                    if($aRow['b_premium']) {
                        ...
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_premium&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;value=1">' . __('Mark as premium') .'</a>';
                    }
                    if($aRow['b_spam']) {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_spam&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;value=0">' . __('Unmark as spam') .'</a>';
                    } else {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_spam&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;value=1">' . __('Mark as spam') .'</a>';
                    }
                ...
                $row['title'] = '<a href="' . osc_item_url() . '" class="text-info" target="_blank">' . $title. '</a>'. $actions;
        ...
        if(!empty($items)) {
            ...
            foreach($items as $aRow) {
                ...
                if(osc_get_preference('admin_theme') == 'modern') {
                    ...
                    $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;stat=all">' . __('Clear All') .'</a>';
                    if( $aRow['i_num_spam'] > 0 ) {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;stat=spam">' . __('Clear Spam') .'</a>';
                    }
                    if( $aRow['i_num_bad_classified'] > 0 ) {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;stat=bad">' . __('Clear Misclassified') .'</a>';
                    }
                    if( $aRow['i_num_repeated'] > 0 ) {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;stat=duplicated">' . __('Clear Duplicated') .'</a>';
                    }
                    if( $aRow['i_num_offensive'] > 0 ) {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;stat=offensive">' . __('Clear Offensive') .'</a>';
                    }
                    if( $aRow['i_num_expired'] > 0 ) {
                        $options_more[] = '<a class="dropdown-item" href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'] . '&amp;' . $csrf_token_url . '&amp;stat=expired">' . __('Clear Expired') .'</a>';
                    }
