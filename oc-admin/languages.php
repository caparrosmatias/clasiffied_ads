            ...
            default:
                ...
                for ($i = $start; $i < $max; $i++) {
                    ...
                    if(osc_get_preference('admin_theme') == 'modern') {
                        ...
                        if ($bLanguagesToUpdate) {
                            if (in_array($l['pk_c_code'], $aLanguagesToUpdate)) {
                                $sUpdate = '<a class="dropdown-item"  href="#' . htmlentities($l['pk_c_code']) . '">' . __("Update here") . '</a>';
                                $options_more[] = $sUpdate;
                            }
                        }
                        ...
                        $btn_actions = '<a href="' . osc_admin_base_url(true) . '?page=languages&action=edit&amp;id=' . $l['pk_c_code'] . '" rel="tooltip" class="btn btn-warning" title="' . __('Edit') . '"><i class="material-icons">edit</i><div class="ripple-container"></div></a>';

                        $btn_actions .= '<a id="listing-delete" data-delete-type="language" data-listing-id="' . $l['pk_c_code'] . '" href="' . osc_admin_base_url(true) . '?page=languages&amp;action=delete&amp;id[]=' . $l['pk_c_code'] . '&amp;' . osc_csrf_token_url() . '" rel="tooltip" class="btn btn-danger" title="' . __('Delete') . '"><i class="material-icons">delete</i><div class="ripple-container"></div></a>';
                        ...
                        $row[] = '<div class="form-check">
                                        <label class="form-check-label">
                                            <input id="item-selected" class="form-check-input" type="checkbox" name="id[]" value="' . $l['pk_c_code'] . '"/>
